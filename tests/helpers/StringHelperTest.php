...
use Asymptix\helpers\StringHelper;
...
class StringHelperTest extends \PHPUnit_Framework_TestCase {
     ...
     *
     * @covers \Asymptix\core\StringHelper::upperCaseFirst
     */
    public function testUpperCaseFirst() {
        $this->assertEquals(
                "Test"
                , StringHelper::upperCaseFirst("test")
        );
    }
    ...
    public function testUpperCaseFirst3() {
        $this->assertEquals(
                "Тест"
                , StringHelper::upperCaseFirst("тест")
        );
    }
    ...
    public function testUpperCaseFirst5() {
        $this->assertEquals(
                "Test case"
                , StringHelper::upperCaseFirst("test case")
        );
    }
    ...
    public function testUpperCaseFirst7() {
        $this->assertEquals(
                "Тест кейс"
                , StringHelper::upperCaseFirst("тест кейс")
        );
    }
    ...
    /**
     * @covers \Asymptix\core\StringHelper::isInstanceOf
    ...
    /**
     * @covers \Asymptix\core\StringHelper::lowerCaseFirst
    ...
    /**
     * @covers \Asymptix\core\StringHelper::upperCaseWords
    ...
    /**
     * @covers \Asymptix\core\StringHelper::upperCase
    ...
    /**
     * @covers \Asymptix\core\StringHelper::lowerCase
